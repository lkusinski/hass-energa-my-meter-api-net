...
trigger:
  - platform: state
    entity_id: binary_sensor.licznik_10000001_cena_ujemna_rce_zagrozenie_eksportu
    to: "on"
action:
  ...
  - service: notify.notify
    data:
      ...
      message: "Cena RCE wynosi {{ states('sensor.licznik_10000001_dynamiczna_cena_energii_rce') }} zł. Załączono grzanie CWU na max."
```
...
trigger:
  - platform: state
    entity_id: binary_sensor.licznik_10000001_okno_ladowania_bess_arbitraz_rce
    to: "on"
action:
