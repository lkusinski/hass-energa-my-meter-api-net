...
- Invoice reconciliation against real document FES_00017.pdf
  (Warzywna, G11, 2159 kWh, period 04.02.2026 - 05.04.2026, 2 months).
...
def test_golden_invoice_fes_00017_reconciliation():
    """Verify that calculated G11 invoice matches FES_00017.pdf line-by-line."""
    # Invoice parameters from PDF
    inv_number = "FES/00017"
