...
class TestConfigureEnergyDashboardButton:
    ...
    async def test_button_press_multi_zone_virtual_storage(self):
        ...
        assert grid["flow_from"][0]["stat_energy_from"] == "sensor.energa_10000001_syntetyczna_siec_pobor_strefa_1"
        assert grid["flow_from"][1]["stat_energy_from"] == "sensor.energa_10000001_syntetyczna_siec_pobor_strefa_2"
        assert len(grid["flow_to"]) == 2
        assert grid["flow_to"][0]["stat_energy_to"] == "sensor.energa_10000001_syntetyczna_siec_oddanie_strefa_1"
    ...
    async def test_button_press_single_zone_physical_grid(self):
        ...
        assert grid["flow_from"][0]["stat_energy_from"] == "sensor.energa_10000003_panel_energia_zuzycie"
        assert len(grid["flow_to"]) == 1
        assert grid["flow_to"][0]["stat_energy_to"] == "sensor.energa_10000003_panel_energia_produkcja"
